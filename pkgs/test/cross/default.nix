...
in
{
  gcc = (lib.mapAttrs (_: mapMultiPlatformTest (system: system // { useLLVM = false; useGccNg = false; })) tests);
  gccNg = (lib.mapAttrs (_: mapMultiPlatformTest (system: system // { useLLVM = true; useGccNg = true; })) tests);
  llvm = (lib.mapAttrs (_: mapMultiPlatformTest (system: system // { useLLVM = true; useGccNg = false; })) tests);
